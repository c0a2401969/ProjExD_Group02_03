...
* 背景を動かす機能 (担当：石田)：背景と障害物、敵の配置を決定するクラス
...
### メモ
* ゴール・敵・はてなブロックの当たり判定は「x軸始点」「y軸始点」「x軸終点」「y軸終点」で指定できるようにしてほしい！
* デバッグの際ステージを固定したいときは、Ctrl+FでSTAGE_BUILDERSを探して指定できる。
* if stage_indexの数を変えたらゴールまでの距離を変えられる。最終的に5~10ぐらいに設定しておいてください。
